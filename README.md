...
- **EC2 instance** in the private subnet (no public IP, no SSH key)
...
- **Security groups** restricting traffic to HTTPS for VPC endpoints and egress-only for the EC2 instance
